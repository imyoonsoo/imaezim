...
<b>IMAEZIM</b>은 AR 기술을 기반으로 사용자가 **현실 공간에 글·사진·영상 형태의 AR 메모를 남기고**
...
AR 환경은 사용자가 기존의 수동적인 정보 수용 방식에서 벗어나 **직접 움직여 탐색하고 참여하는 능동적인 경험**을 가능하게 합니다.  
...
### 🔹 AR 길찾기 
- SNS 게시물에 올라온AR 메모까지 가는 AR 내비게이션 제공  
- GPS + AR 방향 안내<br><br>
### 🔹 AR 게임 
...
## 🎬 [IMAEZIM 시연 영상](https://youtu.be/tUaR9V3uTP4)
> 본 영상은 **IMAEZIM**의 전체 기능과 각 기능이 유기적으로 연결되는 흐름을 한눈에 확인할 수 있는 통합 시연 영상입니다.<br>IMAEZIM이 제안하는 새로운 경험을 지금 확인해보세요!<p align="center"> (※ 영상 클릭 시 유튜브 이동)</p>
...
- **![Android Studio](https://img.shields.io/badge/Android%20Studio-3DDC84?style=flat-square&logo=android-studio&logoColor=white)**&nbsp;&nbsp;—&nbsp;&nbsp;IDE<br><br>
