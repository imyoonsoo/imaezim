...
| **담당**     | AR 실내메모, AR 게임 3D 모델링, Android 앱                      |
...
후면 카메라로 물건을 10장 촬영해 서버로 전송하면, 서버 사이드 **YOLO**가 사진을 분석해 등록된 물건인지 판별합니다. 등록된 물건이면 붙여둔 메모를 불러옵니다.
...
`app/`과 `unity/`는 각각 독립적으로 빌드되는 별도 프로젝트로, 둘 다 Django 백엔드를 통해서만 데이터를 주고받습니다.
...
│       ├── ARActivity.kt          # AR 메뉴 화면
│       └── retrofit/              # 서버 통신 (클라이언트/인터페이스/DTO)
│
└── unity/Assets/              # Unity AR 프로젝트 (C#)
    ├── CloudAnchorManager.cs      # AR 실내메모
    ├── ObjectMemo.cs              # AR 물건메모
...
<table>
  <tr>
    <td align="center" width="150px">
      ...
      <br/>
      <sub>AR 실외메모<br/>AR 게임<br/>AR 퀴즈<br/>Server</sub>
    </td>
    <td align="center" width="150px">
      ...
      <br/>
      <sub>AR 실내메모<br/>AR 게임<br/>Android 앱</sub>
    </td>
    <td align="center" width="150px">
      ...
      <img src="https://img.shields.io/badge/Frontend-3178C6?style=flat-square"/>
      <br/>
      <sub>AR 실내메모<br/>AR 게임 3D 모델링<br/>Android 앱</sub>
    </td>
    <td align="center" width="150px">
      ...
      <img src="https://img.shields.io/badge/Backend-339933?style=flat-square"/>
      <br/>
      <sub>AR 실외메모<br/>AR 물건메모<br/>AR 길찾기<br/>Server</sub>
    </td>
    <td align="center" width="150px">
      ...
      <img src="https://img.shields.io/badge/Frontend-3178C6?style=flat-square"/>
      <br/>
      <sub>AR 실내메모<br/>AR 물건메모<br/>AR 길찾기<br/>Android 앱</sub>
    </td>
  </tr>
</table>
